...
class HAUserAlbumDisplayVC: ASViewController, HAAlbumDisplayNodeDelegate, MediaModelDelegate {
    
    
    let albumDisplayNode: HAAlbumDisplayNode
    
    let albumModel: UserAlbumModel
