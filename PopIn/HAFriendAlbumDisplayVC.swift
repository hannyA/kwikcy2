...
protocol HAFriendAlbumDisplayVCDelegate {
    func removeNewAlbum(album: FriendAlbumModel)
}

class HAFriendAlbumDisplayVC: ASViewController, HAAlbumDisplayNodeDelegate, MediaModelDelegate {
    
    
    var delegate: HAFriendAlbumDisplayVCDelegate?
    
    let albumDisplayNode: HAAlbumDisplayNode
    
    let albumModel: FriendAlbumModel
    ...
    init(album: FriendAlbumModel, isFromNewAlbumSection newSection: Bool) {
        
        albumModel = album
        isNewAlbumSection = newSection
        
        currentMediaContent = isNewAlbumSection ? albumModel.firstNewItem()! : albumModel.firstItem()!
    ...
    convenience init(userAlbum album: FriendAlbumModel) {
